  ...
  return (
    <div className="space-y-6">
          ...
          <Card className="bg-green-900/30 border-green-400/50 flex items-center justify-center">
            <CardContent className="pt-6">
              <div className="text-center">
                <div className="text-5xl font-bold text-green-300 mb-2">{result}%</div>
                <div className="text-base text-green-200">Optimal Oxygen Percentage</div>
                <div className="text-xs text-green-600 mt-2">EAN{Math.round(result)}</div>
              </div>
            </CardContent>
          </Card>
        )}
      ...
      <div className="text-sm text-gray-300 bg-white/5 p-4 rounded-lg">
        ...
        <p className="mt-2">
          <strong>Note:</strong> This calculates the richest Nitrox mix that can be safely used at your planned maximum
          depth.
        </p>
      </div>
    </div>
